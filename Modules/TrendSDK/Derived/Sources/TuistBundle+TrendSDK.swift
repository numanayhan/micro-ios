...
/// Since TrendSDK is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "TrendSDK_TrendSDK"
    var candidates = [
    ...
    fatalError("unable to find bundle named TrendSDK_TrendSDK")
}()
}// MARK: - Objective-C Bundle Accessor
@objc
public class TrendSDKResources: NSObject {
